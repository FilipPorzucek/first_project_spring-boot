package com.example.task_menager.service;

import com.example.task_menager.model.Task;
import com.example.task_menager.model.User;
import com.example.task_menager.repository.TaskRepository;
...
public class TaskService {
    ...
    public void deleteTask(int taskId,User user)
    {
        ...
        if(!task.getUser().getUsername().equals(user.getUsername())){
            throw new IllegalArgumentException("You can only de;ete your task");
        }
